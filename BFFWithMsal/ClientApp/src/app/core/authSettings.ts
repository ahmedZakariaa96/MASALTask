...
export const msalConfig: Configuration = {
  auth: {
    ...
    redirectUri: '/complete', // Points to window.location.origin. You must register this URI on Azure portal/App Registration.
...
export const protectedResources = {
  eventsApi: {
    ...
    scopes: [environment.scopeEndpoint],
  }
}
...
export const loginRequest = {
  scopes: [...protectedResources.eventsApi.scopes],
